...
def get_config():
    ...
    config = ConfigDict()
    config.root = '/mnt/ceph/users/tnguyen/stream/'
    config.name = '6params-uni-ta25'
    config.root_out = '/mnt/ceph/users/tnguyen/stream/preprocessed_datasets/particles'
    config.name_out = 'present-6D'
